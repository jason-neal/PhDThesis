...
\begin{table*}
    ...
    \begin{threeparttable}[b]
        ...
        \caption{Details about the each {CRIRES} observation. The number of artefacts removed in \cref{subsubsec:reductionartefacts} as well as the \snr{} of the combined spectra is provided. The last three columns are the calculated {RV} of both host and largest companion, from the orbital solution, as well as the {RV} difference between the two components.}
