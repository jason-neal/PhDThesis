...
\begin{table*}
    ...
    \begin{threeparttable}[b]
        ...
        \begin{tablenotes}
           \item[] References: (1)~\citet{sahlmann_search_2011}; (2)~\citet{santos_spectroscopic_2005}; (3)~\citet{crepp_trends_2016}; (4)~\citet{tsantaki_deriving_2013}; (5)~\citet{bonfanti_age_2016}; (6)~\citet{santos_spectroscopic_2004}; (7)~\citet{sousa_spectroscopic_2008}; (8)~\citet{gaiacollaboration_gaia_2018}.
        \end{tablenotes}
    \end{threeparttable}
\end{table*}
