...
\end{equation}
$\sqrt{F}$ represents the S/N of the spectrum in the poison-dominated noise regime, while $\Delta \lambda$ is the bandwidth of the observed spectrum. {red{} This assumes that the spectrum contains a homogenous distribution of uniform lines, per unit wavelength. \todo{Finish this relation, R 1.5}}
