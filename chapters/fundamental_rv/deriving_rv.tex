...
\input{./tables/fundamental_rv/rv_semi_amplitudes}
...
\todo{I think this is finished}


\section{Measuring the RV}
\todo{something about measuring the RV and CCF}
Slight motion of the spectral lines on the detector. To use the information form the whole spectrum the cross correlation is common to add all the lines together into a single line. see. ..

This then be comes a property of the spectrum such as line density and number of deep strong lines.


Transition into precision.
