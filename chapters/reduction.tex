...
\begin{figure}[h]
    ...
    \caption{A flat-field image for a detector \#1 before (left) and after(right) the non-linearity corrections are performed. A prefect detector would have all pixels in the flat-field equal to 1. \bf{Remove flat and flatR titles.}}
