...
The design of spectrographs is highly dependant on the wavelength range observed. For instance CCD cameras (based on Silicon) are readily used in the optical but silicon is a  poor detector at \nir{} wavelengths. Instead \nir{} spectrographs need to use CMOS detectors which are composed of different materials to be are sensitive to different wavelengths. CRIRES detectors specifically are made of \ce{InSb} (Indium antimonide) to perform spectroscopy between 1-5\mum{}~\cite{dorn_crires_2004}. 
