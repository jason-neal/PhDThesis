...
Cryogenically cooled and temperature controlled...  


The spectra were initially reduced using the ESO CRIRES pipeline \href{ESO CRIRES pipeline}{ESO CRIRES pipeline}, with Gasgano Gui.  CRIRES pipeline user manual 
