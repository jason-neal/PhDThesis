...
The loading is easily performed using Starfish's \textbf{GridTools}\todo{link from paper}, which can load the library spectra with a list of stellar parameters [\Teff{}, \logg{}, \feh{}, $[alpha/ce{H}]$].
