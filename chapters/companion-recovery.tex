...
For that a model that incorporates the phase information will be needed but is beyond the scope here due to the limited number of observations (1-4). A promising method to incorporate the phase information and detection planetary spectra is given by~\citep{XXX,piskorz_evidence_2016}.
