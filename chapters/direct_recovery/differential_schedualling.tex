...
Community pressure from projects like this lead to the creation of the  ``Monitoring proposals''~\citep[e.g.][pg.~18]{eso_eso_2017}, in the {ESO} context, allowing for observations over multiple periods.
...
However, the lack of BD companions on short periods has a very negative impact on projects like these as there are simply few targets to choose from to observe.
