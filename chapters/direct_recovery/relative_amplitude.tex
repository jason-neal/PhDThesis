...
Further investigation was performed into the differential subtraction when mutually subtracting the companion under small \(\Delta {RV}\).
...
These simulations were focused on the wavelength range 2110--2123\nm{}, corresponding to detector \#1 of the {CRIRES} observations.
...
As the {RV} separation increases in either direction, the individual lines stop completely cancelling each other as they begin to separate.
