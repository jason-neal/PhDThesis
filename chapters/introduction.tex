...
A transit example closer to home is the transit of Venus in 2012 shown in  \fref{fig:transit_venus}, although unlike exoplanets we are also internal to the Solar System.
\begin{figure}
    \centering
...
If a planet is in an edge-on orbit relative to Earth and passes in front of the parent star 
description
