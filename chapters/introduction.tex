...
Astrometry measures the precise position of the stars on the plane of the sky. The motion of a star with an exoplanet about its centre of mass can be observed in the oscillating position on the sky. The astrometry is more sensitive to larger planetary separations, and measures the stellar motion perpendicular to that probed by the RV method. The amplitude of astrometric signal, decreases with distance, as the angles become smaller. This is unlike the RV and transit methods for which the amplitude is not affected by distance.
...
Simulations predict that more than 21000 large mass planets (1-15\mjup) in long-period orbits should be discovered during the 5 year nominal GAIA mission \citet{perryman_astrometric_2014}. 
...
\begin{figure}
\includegraphics[width=0.5\linewidth]{./figures/introduction/microlensing_example} 
