...
Direct imaging requires resolving the angular separation between the star and planet and is best suited to detect giant planets in wide orbits (>10\AU{}) around nearby stars.
 and larger surface area which favour detection.
Young giants observed in the infrared are favoured as they are still cooling and have higher thermal emission and larger surface area resulting in a higher contrast ratio to the host.
...
High-contrast adaptive optics instruments such as SPHERE@VLT\citet{Beuzit_sphere_2008} and GPI at~\citet{macintosh_gemini_2008}) are being used with several different techniques to observed targets closer to the star and with smaller contrasts, usually involving blocking or cancelling out the light from the star while keeping the planet \citep[e.g.[]{marois__2005, schmid_zimpol_2005, sirbu_prospects_2017, sirbu_techniques_2017, mawet_annular_2005, wang_2017}]. Ground based direct imaging requires adaptive optics to reduce the turbulence induced by the atmosphere, decreasing the angular separation resolvable. 
