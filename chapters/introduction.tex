...
Microlensing events are detected and monitors using dedicated global telescope networks \textbf{such as OGLE(), MOA(), microFUN() and PLANET(). } They focus their veiwing towards the eclipic plane where there is a majoritiy of the stars, increasing the chances of alignment.
