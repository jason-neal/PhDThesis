...
Detecting and analysing exoplanet atmospheres aid in the characterization of exoplanets by allowing their temperature, atmospheric structure, the presence any scattering aerosols, and the chemical composition~\citep[e.g.][]{}\todo{references here would be nice}.
All providing clues towards a full exoplanet characterization.

\todo{I am wondering if you could not here already talk a bit about different approaches, mentioning htat the NIR is one of the most promising ones.}
...
\todo{Nuno: I just think it would be good if you could make the bridge
    to Brown-Dwarfs and to NIR spectroscopy a bit stronger. Some of the comments and
    suggestions go in that direction. But since this is an overall suggestion, its not very
    easy to find the best way through. The general impression one has when reading the
    introduction is that the thesis is about planets. But then one realizes it is not. But
    that comes late.}