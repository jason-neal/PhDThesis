...
This work is not directly related to detecting exoplanet atmospheres themselves but will aid in future exoplanet discoveries.\todo{I think this is presented in a negative way and not showing the importance that this type of analysis has.}
...
A objected strived for in the literature~\citep[e.g.][]{reiners_detecting_2010, rodler_detecting_2011a, plavchan_radial_2015}.
...
\todo{I would conclude then saying that the number of papers on this thematic, number of open questions and impact on the design of instrumentation (which is very active for nIR spectrograhs) show that this is an important topic as of today!}
...
\input{chapters/information_content/eniric_results}
