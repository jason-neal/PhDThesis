...
This has been used to being exploring the affect of \Logg{} and \feh{} on the spectral prevision of M-dwarfs, as well as comparing the RV precision of synthetic spectra to observed M-dwarf spectra from {CARMENES}.
Open to the community it is available for the community to aid in {RV} precision calculations.
