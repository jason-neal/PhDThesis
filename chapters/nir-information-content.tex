...
In May 2018 we were requested to provide precision calculations for the NIRPS ETC.\@This extended the spectral range from M0, M3, M6, M9 at 3900. 3500, 2800 2600\K{} respectively, but to all temperatures between 2500 and 4000\K{} inclusively. This provides a finer resolution coverage over the M spectral type, allowed by the {PHOENIX-ACES} library.
...
vsini: float
Projected rotational velocity [\kmps{}]
epsilon: float
...
The rotational broadening kernel is {Grey \ldots{}}
\begin{equation}
Rot =
\end{equation}
