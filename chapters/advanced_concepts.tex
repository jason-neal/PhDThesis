...
\begin{align}
f &= f(x, y, z, \ldots)\\
\delta f &= \sqrt{{\left(\pd{f}{x} \delta x\right)}^2 +  {\left(\pd{f}{y} \delta y\right)}^2 + {\left(\pd{f}{z} \delta z\right)}^2 + \ldots}
\end{align}
