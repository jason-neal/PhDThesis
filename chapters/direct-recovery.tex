...
For HD\,30501 in which there was a large time separation between observations was obtained, and is clearly visible in \fref{fig:hd30501p89}. Unfortunately this did not result in a large enough companion separation. If the observations had been obtained in the previous period (88) instead then sufficient separation could have been obtained due to the orbital eccentricity. {\red{} (this region is due to return in \ldots}
