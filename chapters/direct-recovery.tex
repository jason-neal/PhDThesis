...
For the companion, the mass ($\mtwo{}$ or \mtwosini{})  is used alongside the stellar mass from \cref{tab:stellarparams} to calculate the RV of the companion using \todo{~equations for companion rv with the masses still included, include 180 degree angle phase change also}{\textbf{cref{}}}. This is given as \({RV}_{2}\) in \cref{tab:observations}.
