...
\input{tables/direct_recovery/estimated_fluxratios}
...
$J(\lamda) = 1- D \cdot\exp-\pi (\lambda - \lambda_0)^2 /W^2$:
 ....\begin{equation}
...
\textbf{kostov.. 2013 use a very similar method, choosing two observations from the extrema. They also preform a number of simulations regarding cobseving CRIRES spectra with different brown dwarfs. Figure our the flux ratio limit they get too???}
...
We explored the use of {VISIR} to detect a the spectra of Brown Dwarf companions in the {\mir{}}. The candidate selected as the best target to investigate was {HD\,219828} which has a hot-Neptune (\(M\sin{i} =0.066\)\Mjup) \citep{melo 2007} and a recently discovered super Jupiter (\(M\sin{i} =15.1 \)\Mjup)  on a long period (13 yr) eccentric orbit (e=0.81)\citep{santos 2016}.
