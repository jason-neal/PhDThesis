...
A fairly common technique for matching and separating spectra is to apply cross-correlation against a library of known spectra. TODCOR~\citep{zucker_study_1994} is a commonly used algorithm for cross-correlation of two spectral components and revealing the faint secondary~\citep[e.g.][]{mazeh_detecting_1997} simulated to be able to detect secondaries with flux ratios down to \(\sim1/1000\) provided a sufficient \snr{}\citep{mazeh_todocr_1994}.
