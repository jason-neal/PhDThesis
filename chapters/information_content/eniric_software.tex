...
\begin{itemize}
    ...
    \item Allow for correct scaling when a different sampling , \(\mathrm{s}\), is used. Not restricted to \(\mathrm{s}\)=3.
    \item Allow for the \snr{} scaling to be referenced to a different band or wavelength. Different reference bands available.
