...
One factor that needs consideration when convolving with a non-uniformly spaced spectrum is the discretization\todo{duplicated} of the kernel onto the wavelength grid.
