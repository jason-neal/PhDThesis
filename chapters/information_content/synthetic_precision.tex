...
This was done by normalizing each spectrum, after convolution, to a \snr{} of 100 at the centre of the \emph{J}-band. Specifically this is achieved by summing the three pixels (same as the sampling per resolution element) centred at 1.25\um{} scaling the result so that this sum becomes \(100^2\).
