...
\subsection{Bands}
The spectra are split up into the \nir{} wavelength bands to avoid the regions of strong water absorption in the Earth atmosphere in the \nir{}. These \ce{H2O} regions that defined these bands can be seen in the telluric spectrum in \cref{fig:croppedmolecfitabsorbtion} or in the raw {CARMENES} spectra in \cref{fig:carmenes_raw} Figure~\reference{Add figure here}\todo{Add figure here}.
