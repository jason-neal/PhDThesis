...
In \cref{cha:rv_concepts,cha:nir_spectroscopy} the fundamental concepts of the radial velocity method and \nir{} spectroscopy are presented. In \cref{cha:atmospheres_and_models} models of the atmosphere are presented along with the stellar atmosphere and evolutionary models used in this work.
