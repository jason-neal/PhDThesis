...
\begin{figure}
    ...
    \caption[Number of exoplanet detections per year separated by method.]{Number of exoplanet detections per year separated by method (data from \href{http://www.exoplanet.eu}{exoplanet.eu} October 2018).}
...
%\todo{All this is true, but I feel it is a bit incomplete. And here you are talking no longer about false positives but more about precise characterization. Not sure thus if this paragraph brings the right info in the right place. (but you can rephrase)}{}.
