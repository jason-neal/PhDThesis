...
The gradual decrease in measured mass of exoplanets over time is shown in \fref{fig:exoplaneteuyearmass}.
...
Examples of spots can be seen in the middle of the Sun from an image of the 2012 transit of Venus in \fref{fig:transit_venus_transit_alignment} (left).
...
The presence of spots in successive transits (see \fref{fig:transit_venus_transit_alignment} (right)) can indicate the alignment of the stellar rotation to the planet orbital plane~\citep{sanchis-ojeda_starspots_2013}.
...
This is shown by the clustering of direct image detections shown in \fref{fig:exoplaneteuyearmass}.
