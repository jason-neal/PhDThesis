...
\begin{figure}
    ...
    \caption{Exoplanet discovery year verses exoplanet mass showing a trend towards detecting lower mass planets. Exoplanets without a measured mass are not shown. Colours indicate the initial detection method.}
