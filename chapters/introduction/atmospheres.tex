...
\begin{figure}
    ...
    Sourced from \href{http://www.sc.eso.org/~esedagha/research.html}{\url{http://www.sc.eso.org/~esedagha/research.html}}.}
...
A spectral template of \ce{CO} lines is cross correlated against the series of spectra, resulting in a visible shift the \ce{CO} lines during the transit due to the orbital motion of the exoplanet.
