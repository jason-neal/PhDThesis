...
\textbf{The depth of the occultation, is a direct measurement of the planet-to-star ratio between the star and the planet a }\todo{cite secondary eclipse of reflectance, and secondary spectroscopy examples}.\todo{see exoplanet handbook}
...
In planetary transits, usually defined by their duration and depth, \todo{there are degeneracies in the transit shape from a single band, such as the \(\frac{\Rp}{\Rstar}\) ratio.}{need to be more clear here}
...
\todo{distinguish clouds and hazes.}
