...
\todo{you could mention here that evaporation has been also invoked to explain some planet properties (see Fulton gap or neptune desert)}
...
\todo{I would suggest you make a new section here! Maybe called: "Brown-dwarfs: bridging the gap". And this text is perfect for that section. Maybe actually you can add a bit more stuff inside (more details about some of the things you say).
    This suggestion is to allow the reader to make the bridge between the planets (all you talked up to now) and the brown-dwarfs (that you tried to study in your thesis).}
