...
\begin{figure}
    ...
    \caption{Left: Mass-Radius relationship with probabilistic fit from dwarf planets to late-type stars from~\citet{chen_probabilistic_2016}. The symbols represents the objects used to fit the model, with the key in the top-left. The red line indicates the average value, while the light and dark grey regions indicate the 65\% and 95\% confidence intervals.}
