...
From the flux ratio the noise ratio between the host and companion can also be calculated in a similar way using the equation \(N_{2}/N_{1} = \sqrt{2} \times\sqrt{F_{1}/F_{2}}\).\todo{explain where 2 comes from: I got this from the observing proposal but I have not been able to find a definitive source for this, to explain it. My assumption is it comes from the mutual subtraction stage...}
