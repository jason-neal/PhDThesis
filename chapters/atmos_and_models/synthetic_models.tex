...
A further example of this is shown in \cref{fig:visualinspection-hd2118471} in which an observed {CRIRES} spectra is fitted with a binary model. The flux ratio is 0.066 so the model is dominated by a single {PHOENIX-ACES} model, and shows several line discrepancies.
