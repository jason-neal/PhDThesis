...
There are differences between the models of around 2\% level, with the largest difference near the large telluric line around 2163\nm{}.
\begin{figure}
    \centering
...
This was to explore a known issue with the depth of \ce{H2O} absorption lines in the {TAPAS}~\citet{bertaux_tapas_2014}.

\cref{subsec:telluric_correction_application}
