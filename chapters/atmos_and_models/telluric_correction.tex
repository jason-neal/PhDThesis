...
Typically the absorption of the Earth's atmosphere (telluric lines) is corrected with the standard star method~\citep[e.g.][]{vacca_method_2003}. This method observed a ``standard star'', a very hot (O or A-type), fast rotating star.
These stars have minimal spectral features themselves so reveal the spectrum of the telluric lines. 
...
The observation of the standard star needs to be observed close in the sky and time to the science observation to have a similar atmospheric absorption to the science target.
...
\begin{figure}
    ...
    \caption[Telluric spectra for the \ce{H2O} and non-\ce{H2O} species.]{Telluric absorption spectrum for \ce{H2O} and the non-\ce{H2O} species available from {TAPAS}. In the wavelength range 2110--2170\nm{} and both at a resolution of 50\,000. A vertical offset of 0.1 has been added to the non-\ce{H2O} spectrum.}
