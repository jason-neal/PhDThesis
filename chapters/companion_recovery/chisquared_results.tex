...
%\todo{I think this deserves some extra comments. I would compare the results derived form error propagation to the differences obtained between the measured and the real one (coming fro other methods). I would try to conclude with a lesson on the potential explanations.}
