...
For each model \todo{we} further allow the continuum level to be slightly varied by \(\pm 0.05\) as a free parameter taking the model that fits with the smallest \textchisquared{} value as the choice for this combination of binary parameters.
...
This is likely a very good approximation as all \todo{our} targets have solar metallicity and are thus very likely to belong to the thin disk of the Galaxy, where \alphafe{} values are close to zero, i.e., solar~\citet[e.g.][]{adibekyan_chemical_2012}.
