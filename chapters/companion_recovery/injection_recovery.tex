...
This separation chosen is slightly larger than what we have with our observations, \Rvtwo{} given in \cref{tab:observations}.
...
We apply the recovery method developed above on the injected spectrum, leaving only the companion \(\teffsub{2}\) and \Rvtwo{} parameters free, to recover the injected companion.
