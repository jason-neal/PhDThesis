...
Codes are readily available to perform spectral interpolation which could be utilized for this, two of them are \emph{pyterpol}\footnote{\href{https://github.com/chrysante87/pyterpol}{\url{https://github.com/chrysante87/pyterpol}}.}~\citep{nemravova_xtauri_2016} and \emph{Starfish}\footnote{\href{https://github.com/iancze/Starfish}{\url{https://github.com/iancze/Starfish}}.}~\citep{czekala_constructing_2015}.
