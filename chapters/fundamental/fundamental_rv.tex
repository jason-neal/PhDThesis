...
If more than one planet is present then the gravitational influence of planet on each other become non-Keplerian. i.e. N-body problem? {\textbf{ref}}. In this work were a star has two companions we will only assume Keplerian orbits from individual planets, independently.
