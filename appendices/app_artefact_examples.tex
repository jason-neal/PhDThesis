...
\addtocontents{lof}{\protect\contentsline{figure}{\ref{fig:artefact_example1}--\ref{fig:artefact_example7} \quad {\color{hrefurlcolor} Extra examples of reduced spectra with artefacts.
One for each target.}}{{\color{black}\pageref{fig:artefact_example1}}}{}}
...
The second is that there are more artefacts in the seventh and eight nods with \(\sim\)40\% of the artefacts in the last 2/8 of observations (see \cref{tab:nod_artefact_tally}).
