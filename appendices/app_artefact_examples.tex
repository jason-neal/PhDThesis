...
\addtocontents{lof}{\protect\contentsline{figure}{\ref{fig:artefact_example1}--\ref{fig:artefact_example7} \quad {\color{hrefurlcolor} Extra examples of reduced spectra with artefacts. One for each target.}}{{\color{black}\pageref{fig:artefact_example1}}}{}}
