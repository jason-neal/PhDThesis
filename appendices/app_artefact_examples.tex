...
\Crefrange{fig:artefact_example1}{fig:artefact_example6} show more examples of observed spectra in which spikes and artefacts are observed. Including \cref{fig:artefact_example7}, one example is given for each target, selected to show a variety of the artefacts observed.
