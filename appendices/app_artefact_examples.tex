...
\todo{Style needs to be tweaked also}
 ...
 \begin{figure}
     ...
     \caption{Same as \fref{fig:artefact_example1} but for HD162020. {\red{} change picture} In this case there are several spikes observed but there is no affect in the optimally reduced spectra.}
