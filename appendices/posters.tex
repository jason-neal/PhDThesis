%!TEX root = ../thesis.tex
\section{Posters}\label{appsec:posters}
...
{In this poster I outline the goal of the direct subtraction technique, detailing the data preparation and correct steps needed.
    ...
    The poster is provided on the next page.}% Description
{}
...
% Type: Seminar/Talk/Poster
{2016, Sept.\,09}% Date
{\textit{XXVI Encontro Nacional de Astronomia e Astrof\'{\i}sica (ENAA)}, Aveiro, Portugal}% Location
{ http://gravitation.web.ua.pt/enaa2016}% Website
{20}% Points
