...
\begin{itemize}
    \item I authored {\red{} 1} first author articles -- of which {\red{} zero} got accepted~\textbf{cite} and another is currently undergoing the reviewing process~\textbf{cite}. \todo{Fix up at end}
