...
\begin{abstract}
    ...
    Remaining in the \nir{}, effort was diverted to extend the understanding of radial velocity precision of {M-dwarf} spectra, a focus of new \nir{} instrumentation.
    Software to calculate the radial velocity precision is improved to provide the radial velocity precision estimates for the exposure time calculators of two new \nir{} spectrographs, {NIRPS} and {SPIRou}.
    ...
    \cref{cha:introduction} presents an introduction to detecting exoplanets and their atmospheres along with some exoplanet properties.
    ...
    The theoretical precision of stellar spectra is calculated for the latest generation of near-infrared spectrographs to help detect planets around {M-dwarf} stars.
