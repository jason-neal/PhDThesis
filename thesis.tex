...
%\includeonly{chapters/atmos_and_models}
...
%\includeonly{appendices/proposal}

\begin{document}
    %% This sets the page style and numbering for preliminary sections.
    % THESIS Cover
    \includepdf[fitpaper,pages={1}]{./cover/cover_FCUP_JasonNeal_2019.pdf}
    \cleardoublepage
    ...
    \cleardoublepage{}
    \include{chapters/fundamental_rv}
    \cleardoublepage{}
    \include{chapters/nir_spectroscopy}
    \cleardoublepage{}
    \include{chapters/atmos_and_models}
    \cleardoublepage{}
    ...
    \appendix
    \addtocontents{toc}{\protect\setcounter{tocdepth}{0}}  % remove appendix sections
